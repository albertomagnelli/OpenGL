...
Der Renderkontext wird mit Hilfe der GLFW Bibliothek erstellt.
...
Am Ende des Programmes wird diese Bibliothek mittel glfwTerminate() wieder freigegeben.
...
Anschließend kann das Renderfenster erstellt werden, und das zugehörige Kontext als aktuell gesetzt werden.
